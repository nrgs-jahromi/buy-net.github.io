...
import { Box, Typography, SwipeableDrawer, styled, Button } from "@mui/material";
    ...
    >
      ...
      <Box className="p-6">
        <FormikProvider value={formik}>
            ...
            >
        <Typography variant="body1" fontWeight={"bold"} align="center">ویرایش نام کاربری</Typography>
